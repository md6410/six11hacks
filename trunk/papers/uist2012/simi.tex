...
\subfloat[] {
  \label{fig:cintiq} 
  \includegraphics[width=0.45\linewidth]{img/simi-with-cintiq.png} 
}
\subfloat[] {
    \label{fig:lg-pencil-holder}
    \includegraphics[width=0.45\linewidth]{img/lg-pencil-holder.png}
}
...
\caption{Automatic and manual latching. This is the term for bringing
  segments together to meet at a common point.}
\label{fig:latch}
\end{figure}
