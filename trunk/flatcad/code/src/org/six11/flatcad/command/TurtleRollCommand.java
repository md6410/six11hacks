 ...
 * 
 **/
public class TurtleRollCommand extends TurtleCommand {

  public TurtleRollCommand(Output output, TurtleModel model, Component comp, String... names) {
  ...
  public void execute(List<String> args) {
	...
	model.addAction(new Turtle(0f, 0f, num, 0f, Turtle.PEN_USE_CURRENT));
	component.repaint();
      } catch (Exception ex) {
